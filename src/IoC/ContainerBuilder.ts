...
export default class ContainerBuilder {
    public static buildContainer(): Container {
        ...
        //AMQP Connection
        container
            .bind<IConnectionManager>(Types.IConnectionManager)
            .to(RabbitMQConnectionManager)
            .inSingletonScope();
        container
            .bind<IMessageBus<ISerializable, AbstractMessage<ISerializable>>>(Types.IMessageBus)
            .to(RabbitMQBus)
            .inSingletonScope();
